...
set(Qt5WaylandCompositor_VERSION_STRING 5.7.1)
...
macro(_populate_WaylandCompositor_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::WaylandCompositor PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5WaylandCompositor_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        "IMPORTED_SONAME_${Configuration}" "libQt5WaylandCompositor.so.5"
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5WaylandCompositor_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::WaylandCompositor)
    ...
    set(_Qt5WaylandCompositor_OWN_INCLUDE_DIRS "${_qt5WaylandCompositor_install_prefix}/include/" "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor")
    set(Qt5WaylandCompositor_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor/5.7.1"
        "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor/5.7.1/QtWaylandCompositor"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandCompositor_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.7.1 ${_Qt5WaylandCompositor_FIND_VERSION_EXACT}
    ...
    _populate_WaylandCompositor_target_properties(RELEASE "libQt5WaylandCompositor.so.5.7.1" "" )
    ...
    macro(_populate_WaylandCompositor_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WaylandCompositor_install_prefix}/plugins/${PLUGIN_LOCATION}")
        _qt5_WaylandCompositor_check_file_exists(${imported_location})
