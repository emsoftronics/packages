...
set(Qt5WaylandClient_VERSION_STRING 5.7.1)
...
macro(_populate_WaylandClient_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::WaylandClient PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5WaylandClient_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        "IMPORTED_SONAME_${Configuration}" "libQt5WaylandClient.so.5"
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5WaylandClient_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::WaylandClient)
    ...
    set(Qt5WaylandClient_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandClient_install_prefix}/include/QtWaylandClient/5.7.1"
        "${_qt5WaylandClient_install_prefix}/include/QtWaylandClient/5.7.1/QtWaylandClient"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandClient_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.7.1 ${_Qt5WaylandClient_FIND_VERSION_EXACT}
    ...
    _populate_WaylandClient_target_properties(RELEASE "libQt5WaylandClient.so.5.7.1" "" )
